...
-- 납부 수단은 계좌이체 전용. 배정·수거 건은 입금 확인(COMPLETED) 이후 상태.
...
(
    'JC-20260914-000101', 'RECEIVED', 'transfer', 'PENDING_TRANSFER',
    '충청북도 제천시 의병대로 123 (청전동)', '101동 앞 분리수거장 옆',
    37.1425, 128.2114, '청전·의림', NULL, NULL, 5000,
    now() - interval '2 hours', now() - interval '2 hours'
),
(
    'JC-20260914-000102', 'ASSIGNED', 'transfer', 'COMPLETED',
...
(
    'JC-20260914-000103', 'COLLECTED', 'transfer', 'COMPLETED',
...
(
    'JC-20260914-000104', 'UNCOLLECTED', 'transfer', 'COMPLETED',
...
(
    'JC-20260914-000105', 'CHANGE_REQUESTED', 'transfer', 'COMPLETED',
...
('JC-20260914-000102', 'PAYMENT_CONFIRMED', 'RECEPTION', now() - interval '2 hours'),
('JC-20260914-000102', 'ASSIGNED', 'RECEPTION', now() - interval '1 hour'),
('JC-20260914-000103', 'REPORT_CREATED', 'CITIZEN', now() - interval '1 day'),
('JC-20260914-000103', 'PAYMENT_CONFIRMED', 'RECEPTION', now() - interval '20 hours'),
...
('JC-20260914-000104', 'PAYMENT_CONFIRMED', 'RECEPTION', now() - interval '6 hours'),
...
('JC-20260914-000105', 'PAYMENT_CONFIRMED', 'RECEPTION', now() - interval '3 hours'),
